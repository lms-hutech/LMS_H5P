...
var _parentEditor = (function(){try{return window.parent.H5PEditor}catch(e){return null}})(); window.ns = window.H5PEditor = (_parentEditor && _parentEditor.widgets) ? H5P.jQuery.extend(false, {}, _parentEditor) : (window.H5PEditor || {});
ns.language = ns.language || {};
ns.$ = H5P.jQuery;
window.jQuery = H5P.jQuery;

// Load needed resources from parent.
var _parentIntegration = (function(){try{return window.parent.H5PIntegration}catch(e){return null}})(); if(_parentIntegration && _parentIntegration.editor) { H5PIntegration = H5P.jQuery.extend(false, {}, _parentIntegration); }
