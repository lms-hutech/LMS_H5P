...
```bash
MONGODB_URL="mongodb://127.0.0.1:27017" MONGODB_DB=testdb1 MONGODB_USER=root MONGODB_PASSWORD=change-me-mongodb-password LIBRARYSTORAGE=mongo LIBRARY_MONGO_COLLECTION=h5p npm start
```
